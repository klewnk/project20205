...
public class PropertyController {
    ...
    // Προβολή λίστας εγκεκριμένων ακινήτων
//    @GetMapping("/list")
//    public String listProperties(Model model) {
//        List<Property> properties = propertyService.getApprovedProperties(); // Φέρνει μόνο εγκεκριμένα ακίνητα
...
//        return "applications-list"; // Αρχείο HTML που θα εμφανίζει τη λίστα των αιτήσεων
//    }
...
//        propertyService.saveProperty(property);
//        model.addAttribute("message", "The property was added successfully and is pending approval!");
//        return "redirect:/properties/list"; // Επιστροφή στη λίστα ακινήτων
//    }
//
//    // Προβολή λεπτομερειών ακινήτου
//    @GetMapping("/details/{id}")
...
//    public String viewApplicationsForProperty(@PathVariable Long propertyId, Model model) {
//        List<RentalApplication> applications = rentalApplicationService.getApplicationsByPropertyId(propertyId);
//        model.addAttribute("applications", applications);
//        model.addAttribute("propertyId", propertyId);
//        return "properties/applications"; // Συνδέεται με το template που θα δημιουργήσουμε
//    }
//
//    //    // Αρχική σελίδα (Home Page)
////    @GetMapping("/")
////    public String home() {
////        return "home"; // Συνδέεται με το templates/home.html
////    }
////
////    // Αναζήτηση ακινήτων με φίλτρα
//    @GetMapping("/search")
